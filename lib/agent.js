...
Agent.prototype.flush = function (cb) {
  console.log('XXX Agent.flush start')
...
Agent.prototype._flush = function (opts, cb) {
  ...
  if (this._inflightEvents.size === 0) {
    console.log('XXX Agent._flush: no _inflightEvents events')
  ...
  flushingInflightEvents.setDrainHandler((drainErr) => {
    console.log('XXX Agent._flush: flushingInflightEvents drain handler, drainErr=', drainErr)
  ...
  console.log('XXX Agent._flush: set drain handler')
