...
Agent.prototype.captureError = function (err, opts, cb) {
  ...
  // outcome handling for external spans is handled elsewhere
  if (span && span.type !== 'external' && !skipOutcome) {
    span._setOutcomeFromErrorCapture(constants.SPAN.OUTCOME.FAILURE)
  }
