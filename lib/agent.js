...
Agent.prototype._startOTelBridge = function () {
  ...
  // XXX s/Elastic/OTel
  const { OTelContextManager } = require('./otelbridge/OTelContextManager')
  const { OTelPropagator } = require('./otelbridge/OTelPropagator')
  const { OTelTracerProvider } = require('./otelbridge/OTelTracerProvider')
  const { OTelTracer } = require('./otelbridge/OTelTracer')
