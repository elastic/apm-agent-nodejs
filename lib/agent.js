...
Agent.prototype.start = function (opts) {
  ...
  this.logger.info(preambleData, 'Elastic APM Node.js Agent, version: %s', version)

  if (isPreviewVersion) {
    this.logger.warn('Version %s is a pre-release and not intended for use in production environments', version)
  }
