...
class RunContext {
  ...
  currSpan () {
    ...
    // XXX considered, hope I don't need it.
...
class BasicRunContextManager {
  ...
  bindFn (runContext, target) {
    ...
    // XXX comment this out? rarely useful and noisy
  ...
  // This implementation is adapted from OTel's AbstractAsyncHooksContextManager.ts `_bindEventEmitter`.
