...
function frameFromCallSite(
  ...
  getSourceMapConsumer(
    callsite,
    function onSourceMapConsumer(sourceMapErr, sourceMapConsumer) {
      ...
      if (sourceMapErr) {
        ...
        try {
          ...
          log.debug(
            { filename, line: lineno, err: sourceMapErr },
        ...
        if (pos.source !== null) {
          ...
          absMappedFilename = path.resolve(
