 ...
 */
function getMetadataAwsV1 (host, port, connectTimeoutMs, resTimeoutMs, protocol, logger, cb) {
  const headers = {}
  getMetadataAws(
    host,
    port,
 ...
 * https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-identity-documents.html
 */
function getMetadataAwsV2 (host, port, connectTimeoutMs, resTimeoutMs, protocol, logger, cb) {
