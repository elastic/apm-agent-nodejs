...
export default class Agent {
  ...
  /**
   * @deprecated apm.lambda(...) is used for old deprecated Lambda instrumentation.
   */
  ...
  // Utils
  logger: Logger; // Actually a PinoLogger, but we don't promise that for future compat.
