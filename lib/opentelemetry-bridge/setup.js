...
function setupOTelBridge (agent) {
  ...
  // XXX Is this needed? I *think* only if supporting baggage, e.g.
  //    `otel.propagation.setBaggage(...)`. I don't fully grok that yet.
  //    Does it assume use of the W3CBaggagePropagator? Yes.
  //    So then, would users want our SDK to support @opentelemetry/core
