...
function instrumentationS3 (orig, origArguments, request, AWS, agent, { version, enabled }) {
  ...
  const onComplete = function (response) {
    ...
    const dbContext = { type: SUBTYPE }
    if (resource) {
      // XXX This is part of https://github.com/elastic/apm/pull/674 Q7, still being discussed.
      dbContext.instance = resource
    }
