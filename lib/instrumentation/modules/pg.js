      ...
      if (trace) {
        ...
        if (typeof cb === 'function') {
          ...
          if (typeof query.on === 'function') {
            ...
            debug('ERROR: unknown pg query type: %s %o', typeof query, { uuid: uuid })
          }
  ...
  function wrapPulseQueryQueue (orig) {
    return function wrappedFunction () {
      if (this.queryQueue) {
        ...
        if (query && typeof query.callback === 'function' && query.callback.name !== 'opbeatCallbackWrapper') {
          query.callback = opbeat._instrumentation.bindFunction(query.callback)
        }
      } else {
