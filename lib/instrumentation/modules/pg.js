  ...
  function wrapPulseQueryQueue (orig) {
    return function wrappedFunction () {
      if (this.queryQueue) {
        ...
        // XXX this check to elasticAPMCallbackWrapper from 4y ago can be dropped because RunContextManager.bindFunction will no-op an already bound function. Q: is there a test case for this?
