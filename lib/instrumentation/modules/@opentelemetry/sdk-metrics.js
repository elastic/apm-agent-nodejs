...
// This instruments '@opentelemetry/sdk-metrics' to automatically a metric
...
module.exports = function (mod, agent, { version, enabled }) {
  ...
  // XXX .tav for otel/sdk-metrics?
  if (!semver.satisfies(version, '>=1 <2', { includePrerelease: true })) {
