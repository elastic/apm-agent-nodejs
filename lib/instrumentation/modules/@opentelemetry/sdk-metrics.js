...
module.exports = function (mod, agent, { version, enabled }) {
  ...
  // Minimum supported version is 2.0.0. In OTel SDK 2.x the `MeterProvider`
  // requires metric readers to be passed via the constructor `readers` option;
  // the `addMetricReader()` method was removed.
