  ...
  return [
    {
      middleware: (next, context) => async (args) => {
        ...
        try {
          ...
          console.log('>>>>> useArnRegion ', typeof client.config.useArnRegion)
          console.log('>>>>> region ', typeof client.config.region)
          ...
          let region
          if (useArnRegion && args.input.Bucket.startsWith('arn:')) {
