...
module.exports = function (mod, agent, { version, enabled }) {
  ...
  function wrapEachBatch(origEachBatch) {
    return async function (payload) {
      ...
      // We should add a span_link for each meesage fo the batch
      // https://github.com/elastic/apm/blob/e1564e3addd9f373b6551eab89483d07ed3ff313/specs/agents/tracing-instrumentation-messaging.md?plain=1#L81
      // TODO:
