  ...
  class ApmClient extends elasticsearch.Client {
    constructor (...args) {
      ...
      this.on('request', (err, result) => {
        ...
        // Disabling this "feature/hack", because it can be done by the app
        // with the esclient "request" event:
        ...
        //     })
        //
        // // Support ES slowlog by passing through possible context baggage to
        // // x-opaque-id header.
        // const baggageString = span.transaction._context.toBaggageString()
        // if (baggageString) {
        //   const headers = request.params.headers || {}
        //   headers['x-opaque-id'] = baggageString
        // }
