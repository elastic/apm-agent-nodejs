    ...
    constructor (...args) {
      ...
      this.on('response', (err, result) => {
        ...
        if (err) {
          ...
          // Some of these fields we want to include in the captured error, some
          // not. Current `captureError` will include all non-object fields.
          const errOpts = {}
          ...
          delete err.data // possibly large or private user data
