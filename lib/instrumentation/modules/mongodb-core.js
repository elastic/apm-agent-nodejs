...
module.exports = function (mongodb, client) {
  ...
  function wrapCommand (orig) {
    return function wrappedFunction (ns, cmd) {
      ...
      client.logger.trace('intercepted call to mongodb-core.Server.prototype.command (transaction: %sactive, ns: %s)', trans ? '' : 'in', ns)
      ...
      function wrappedCallback () {
        client.logger.trace('intercepted mongodb-core.Server.prototype.command callback')
        trace.end()
  ...
  function wrapQuery (orig, name) {
    return function wrappedFunction (ns) {
      ...
      client.logger.trace('intercepted call to mongodb-core.Server.prototype.%s (transaction: %sactive, ns: %s)', name, trans ? '' : 'in', ns)
      ...
      function wrappedCallback () {
        client.logger.trace('intercepted mongodb-core.Server.prototype.%s callback', name)
        trace.end()
        return cb.apply(null, arguments)
      }
    }
  ...
  function wrapCursor (orig, name) {
    return function wrappedFunction () {
      ...
      client.logger.trace('intercepted call to mongodb-core.Cursor.prototype.%s (transaction: %sactive)', name, trans ? '' : 'in')
      ...
      function wrappedCallback () {
        client.logger.trace('intercepted mongodb-core.Cursor.prototype.%s callback', name)
        trace.end()
        return cb.apply(null, arguments)
      }
    }
