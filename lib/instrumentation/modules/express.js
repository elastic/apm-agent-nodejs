            ...
            shimmer.wrap(layer, 'handle_request', function (orig) {
              return function (req, res, next) {
                if (req.route) {
                  ...
                  if (!req[sym.expressMountStack]) req[sym.expressMountStack] = [fn]
                  else req[sym.expressMountStack].push(fn)

                  arguments[2] = function () {
                    req[sym.expressMountStack].pop()
