...
Instrumentation.prototype.start = function () {
  ...
  const lambdaHandlerInfo = this.getLambdaHandler(process.env)
...
Instrumentation.prototype._startHook = function () {
  ...
  this._hook = hook(this._patches.keys, function (exports, name, basedir) {
    ...
    const lambdaHandlerInfo = self.getLambdaHandler(process.env)
...
Instrumentation.prototype.getLambdaHandler = function (env) {
