...
const { FibersContextManager } = require('./run-context/FibersRunContextManager');
...
Instrumentation.prototype.start = function (runContextClass) {
  ...
  if (confContextManager === CONTEXT_MANAGER_FIBERS) {
    this._runCtxMgr = new FibersContextManager(
      this._log,
      runContextClass,
    );
