...
var MODULES = [
  ...
  'apollo-server-core',
  'aws-sdk',
  // The second is for the installation of 'azure-functions-nodejs-worker'
  // in the distribution of the 'azure-functions-core-tools' package -- the one
  // that provides the `func` tool.
  ['azure-functions-nodejs-worker/dist/src/worker-bundle', 'azure-functions-core-tools/bin/workers/node/dist/src/worker-bundle'],
  'bluebird',
  'cassandra-driver',
  'elasticsearch',
  'express',
