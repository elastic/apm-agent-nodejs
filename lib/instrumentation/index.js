...
function Instrumentation (agent) {
  ...
  Object.defineProperty(this, 'currentTransaction', {
    get () {
      this._log.error({ err: new Error('here') }, 'XXX getting <Instrumentation>.currentTransaction will be REMOVED, use .currTx()')
      return this.currTx()
    },
    set () {
...
// XXX change this to currTrans()? "Tx" definitely isn't common in here.
