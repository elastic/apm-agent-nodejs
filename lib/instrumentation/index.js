...
// Node v18.0.0 added fetch support based on undici@5.0.0. We can instrument undici >=v4.7.0.
const nodeHasInstrumentableFetch = semver.satisfies(process.versions.node, '>=18.0.0')
