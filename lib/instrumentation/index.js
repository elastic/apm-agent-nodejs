...
//    that is used to track run context. It must be `RunContext` (the typical
//    case) or must subclass it. The OTel Bridge uses this to provide a subclass
//    that bridges to OpenTelemetry `Context` usage.
