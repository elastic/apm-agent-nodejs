...
var MODULES = ['http', 'https', 'generic-pool', 'mongodb-core', 'pg', 'mysql', 'mysql2', 'express', 'hapi', 'redis', 'ioredis', 'bluebird', 'knex', 'koa-router', 'ws', 'graphql', 'express-graphql', 'elasticsearch', 'handlebars']
