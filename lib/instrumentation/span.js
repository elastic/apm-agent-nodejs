...
Span.prototype.end = function (endTime) {
  ...
  console.warn('XXX before infer: ', this._destination)
  if (this._excludeDestinationService) {
    console.warn('XXX _excludeDestinationService: ')
    // pass through
  } else if (this._destinationServiceResource) {
    console.warn('XXX _destinationServiceResource: ', this._destinationServiceResource)
    ...
    console.warn('XXX _exitSpan: resource=', resource)
    this._destination.service = {
      resource: resource,
      // Required fields in intake API <=v7.15.
      name: '',
...
Span.prototype._setDestinationAddress = function (host, port) {
  if (!this._destination) {
    this._destination = {}
  }
