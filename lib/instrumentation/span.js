...
function Span (transaction, name, ...args) {
  ...
  console.log('XXX activeSpan', transaction._agent._instrumentation.activeSpan)
  ...
  this._agent.logger.debug('start span %o', { executionAsyncId: asyncHooks.executionAsyncId(), span: this.id, parent: this.parentId, trace: this.traceId, name: this.name, type: this.type, subtype: this.subtype, action: this.action })
}
...
Span.prototype.setOutcome = function (statusCode) {
  /**
