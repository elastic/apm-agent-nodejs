...
Transaction.prototype.toJSON = function () {
  ...
  if (!this.sampled && (this.sample_rate)) {
    // "For non-sampled transactions the sample_rate field MUST be set to 0, to
    //  ensure non-sampled transactions are not counted in transaction metrics"
    payload.sample_rate = 0
  } else if (this.sample_rate || this.sample_rate === 0) {
    ...
    //  their spans."
    payload.sample_rate = parseFloat(this.sample_rate)
  }
