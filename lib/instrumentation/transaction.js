...
function Transaction (agent, name, ...args) {
  ...
  // XXX _abortTime stopped being used in commit faf1dbda1c287e33d5025252fbc253a07e4dffb0 (5y ago)
  this._breakdownTimings = new ObjectIdentityMap()
  this._faas = undefined
  this._service = undefined
  this._message = undefined
  this._cloud = undefined
  this.duration = null // Duration in milliseconds. Set on `.end()`.
...
Transaction.prototype.end = function (result, endTime) {
  ...
  this.duration = this._timer.duration
