...
Transaction.prototype.setOutcome = function (statusCode) {
  this.setOutcomeFromStatusCode(statusCode)
}

Transaction.prototype.setOutcomeFromStatusCode = function (statusCode) {
  if (statusCode >= 500) {
