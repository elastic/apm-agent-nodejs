...
function Transaction (agent, name, type, opts = {}) {
  GenericSpan.call(this, type, agent, opts)
...
Transaction.prototype.startSpan = function (name, type, opts) {
  ...
  if (!opts) {
    opts = {
      timer: this._timer,
      traceContext: (this._agent._instrumentation.activeSpan || this)._context
    }
    ...
    opts.timer = this._timer
    if (!opts.traceparent) {
      opts.traceContext = (this._agent._instrumentation.activeSpan || this)._context
    }
  }
