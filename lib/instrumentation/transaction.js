...
Transaction.prototype.setBaggageEntry = function (key, entry) {
  this._context.baggage.setEntry(key, entry)
}
Transaction.prototype.getBaggageEntry = function (key) {
  return this._context.baggage.getEntry(key)
}
