...
function Transaction (agent, name, ...args) {
  ...
  this._droppedSpanStatistics = new DroppedSpanStats
...
Transaction.prototype.toJSON = function () {
  var payload = {
    ...
    faas: this._faas,
    dropped_spans_stats: this._droppedSpanStatistics.encode()
  }
...
Transaction.prototype.captureDroppedSpan = function(span) {
  return this._droppedSpanStatistics.captureDroppedSpan(span)
}
