...
const GenericSpan = require('./generic-span')
...
const { TransactionIds } = require('./ids')
...
Transaction.prototype.setDefaultNameFromRequest = function () {
  const req = this.req
  let path = getPathFromRequest(req, false, this._agent._conf.usePathAsTransactionName)
