...
Transaction.prototype.createSpan = function (...spanArgs) {
  ...
  // XXX Here is the right place for handling of null if child of exit span diff type or subtype.
  // (actually the node.js agent could currently skip the type/subtype check because we don't do
  // that like the example in the spec).
