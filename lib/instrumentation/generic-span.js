...
GenericSpan.prototype._serializeOTel = function (payload) {
  ...
  // XXX TODO mapping: https://github.com/elastic/apm/blob/main/specs/agents/tracing-api-otel.md#attributes-mapping
  //    These are Transaction vs Span specific, so perhaps move this to the
  //    individual serialize functions.
  // XXX Earlier than apm server 7.16: map to labels? Is this fraught if the
  //     OTel attributes rules (https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/common/README.md#attribute)
  //     allow values not allowed by some early APM server versions?
  //     non-strings? arrays with null values?
}
