...
Object.defineProperty(GenericSpan.prototype, 'id', {
  enumerable: true,
  get () {
    return this._traceContext.traceparent.id
  }
})
...
Object.defineProperty(GenericSpan.prototype, 'traceId', {
  enumerable: true,
  get () {
    return this._traceContext.traceparent.traceId
  }
})
...
Object.defineProperty(GenericSpan.prototype, 'parentId', {
  enumerable: true,
  get () {
    return this._traceContext.traceparent.parentId
  }
})
...
Object.defineProperty(GenericSpan.prototype, 'sampled', {
  enumerable: true,
  get () {
    return this._traceContext.traceparent.recorded
  }
})
...
Object.defineProperty(GenericSpan.prototype, 'sampleRate', {
  enumerable: true,
  get () {
    const rate = parseFloat(this._traceContext.tracestate.getValue('s'))
    if (rate >= 0 && rate <= 1) {
      return rate
    }
    return null
...
Object.defineProperty(GenericSpan.prototype, 'traceparent', {
  enumerable: true,
  get () {
    return this._traceContext.toString()
  }
})
