...
// Object.defineProperty(GenericSpan.prototype, 'sample_rate', {
//   enumerable: true,
//   get () {
...
GenericSpan.prototype.getTraceContextSampleRate = function () {
  if (typeof this.sample_rate === 'undefined') {
    const rate = parseFloat(this._context.tracestate.getValue('s'))
    this.sample_rate = null
    if (rate || rate === 0) {
      this.sample_rate = parseFloat(this._context.tracestate.getValue('s'))
    }
  }
