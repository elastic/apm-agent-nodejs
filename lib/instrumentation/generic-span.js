...
GenericSpan.prototype.propagateTraceContextHeaders = function (currentHeaders, contextFrom) {
  return this._context.propagateTraceContextHeaders(currentHeaders, contextFrom)
}

GenericSpan.prototype.hasPropagateTraceContextHeaders = function () {
  return this._context.hasPropagateTraceContextHeaders()
}
