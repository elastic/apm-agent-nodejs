...
class TraceContext {
  ...
  propagateTraceContextHeaders (carrier, contextFrom, setter) {
    return propagateTraceContextHeaders(carrier, contextFrom, setter)
  }
}

function propagateTraceContextHeaders (carrier, contextFrom, setter) {
