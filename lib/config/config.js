...
class Config {
  constructor (opts, logger) {
    ...
    this.loggingPreambleData = getLoggingPreambleData(this, sources, configFilePath)
  }
 ...
 * @param {Array<{ name: string, ops: Object}>} sources The list of sources of options ordered by priority
...
function getLoggingPreambleData (config, sources, configFilePath) {
  ...
  configKeys.forEach(key => {
    ...
    result.config[key] = {
      ...
      source: sourceName,
      sourceValue: formatOptionValue(optsFromSources[key], shouldRedact),
      normalizedValue: formatOptionValue(config[key], shouldRedact)
    }
    if (sourceName === 'file') {
