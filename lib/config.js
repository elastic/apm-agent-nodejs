...
var ENV_TABLE = {
  ...
  disableTransactions: 'ELASTIC_APM_DISABLE_TRANSACTIONS'
}
...
function normalizeSets (opts) {
  SET_OPTS.forEach(function (key) {
    if (key in opts) opts[key] = new Set(maybeSplit(opts[key]))
  })
}
