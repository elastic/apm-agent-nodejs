...
// XXX REVIEW-NOTE: This is based off stackman.properties() that was used before.
...
function createAPMError (args, cb) {
  ...
  if (args.exception) {
    ...
    // XXX REVIEW-NOTE: This is a slight change in guards on `opts.message` from before that I think more closely matches the API docs.
    ...
    gatherStackTrace(
      ...
      function (_err, stacktrace) {
        ...
        // XXX REVIEW-NOTE bug fix from #1920  s/module/moduleName
        if (moduleName) {
