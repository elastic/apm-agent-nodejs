...
/*
TODO:
- toJSON on "Config" to avoid `logger` at least
- new warning if the given 'logLevel' static config is bogus
- update `logLevel` docs to point to the new names only
- tests
- central config new log_level:
    - validate in known set or ignore
    - update or replace config.logger as appropriate
- startup config of logging
*/
