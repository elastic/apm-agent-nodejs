...
exports.parseText = function (message, options) {
  options = options || {};
  options.message = message;
  return options;
};

exports.parseError = function (err, options, cb) {
...
exports.parseRequest = function (req, options) {
  ...
  options.http = {
    method       : req.method,
    url          : protocol + '://' + host + req.url, // TODO: Should the query string be removed from the URL?
