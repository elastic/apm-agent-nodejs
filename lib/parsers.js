...
exports.parseCallsite = function (callsite, isError, conf, cb) {
  ...
  var lines = isError
    ? (callsite.isApp() ? conf.sourceContextErrorAppFrames : conf.sourceContextErrorLibraryFrames)
    : (callsite.isApp() ? conf.sourceContextTraceAppFrames : conf.sourceContextTraceLibraryFrames)
