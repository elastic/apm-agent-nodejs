...
/**
 * Returns an instance of Elastc APM HTTP client ready to send data
 * @param {any} config Configuration object
 * @param {any} agent
 */
function createElasticAPMTransport (config, agent) {
  const clientConfig = getHttpClientConfig(config, agent)
  const transport = new ElasticAPMHttpClient(clientConfig)
 ...
 *
 * @param {any} conf The agent configuration object
 * @param {any} agent
 * @returns {any}
 */
