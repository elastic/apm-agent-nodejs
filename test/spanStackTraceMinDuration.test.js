...
tape.test('spanStackTraceMinDuration default is no span.stacktrace, even if over 10ms duration', function (t) {
...
tape.test('span faster than configured spanStackTraceMinDuration should have no stacktrace', function (t) {
...
tape.test('span slower than configured spanStackTraceMinDuration should have stacktrace', function (t) {
...
tape.test('spanStackTraceMinDuration=<negative> means no span stack traces', function (t) {
...
tape.test('spanFramesMinDuration=<zero> means always have span stack traces', function (t) {
