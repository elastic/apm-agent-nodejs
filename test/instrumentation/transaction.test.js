...
test('init', function (t) {
  ...
  t.test('options.childOf', function (t) {
    ...
    t.strictEqual(trans._traceContext.traceparent.version, '00')
    t.strictEqual(trans._traceContext.traceparent.traceId, '4bf92f3577b34da6a3ce929d0e0e4736')
    t.notEqual(trans._traceContext.traceparent.id, '00f067aa0ba902b7')
    t.strictEqual(trans._traceContext.traceparent.parentId, '00f067aa0ba902b7')
    t.strictEqual(trans._traceContext.traceparent.flags, '01')
    t.end()
  })
})
