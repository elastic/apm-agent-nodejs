...
const { createApmClient, userAgentFromConf } = require('../../lib/apm-client/apm-client')
...
test('#createApmClient - elastic APM Transport', (t) => {
  ...
  t.ok(transport instanceof HttpApmClient, 'transport should be an ElasticAPMHttpClient instance')
  agent.destroy()
  t.end()
})
