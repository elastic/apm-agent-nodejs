...
[small]#Added in: v3.29.0, replaces <<capture-span-stack-traces,`captureSpanStackTraces`>> and <<span-frames-min-duration,`spanFramesMinDuration`>>#
...
[small]#Deprecated in: v3.29.0, use <<span-stack-trace-min-duration,`spanStackTraceMinDuration`>>#
...
In versions before v3.29.0 this option was `true` by default. As of version
v3.29.0 this default has _effectively_ changed to false, because the default is
