...
[float]
[[supported-technologies-custom-transactions]]
=== Custom Transactions
...
[float]
[[supported-technologies-tracing-and-instrumentation]]
...
[float]
[[supported-technologies-better-stack-traces]]
==== Better Stack Traces
...
[float]
[[supported-technologies-continuity]]
==== Continuity
