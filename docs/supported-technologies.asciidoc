...
| <<nextjs,Next.js>>    | >=11.1.0 <13.0.0 | (Experimental) Names incoming HTTP transactions based on Next.js routing and reports errors in user pages. Supports the Next.js production server (`next start`) and development server (`next dev`). See the <<nextjs,Getting Started doc>>.
|=======================================================================
