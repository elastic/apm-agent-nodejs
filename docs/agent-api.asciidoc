...
[[source-context-span]]
===== `sourceContextSpanAppFrames` + `sourceContextSpanLibraryFrames`
...
* *Type:* Number
* *Default:* `5`
* *Env:* `ELASTIC_APM_SOURCE_CONTEXT_SPAN_APP_FRAMES`
...
* *Type:* Number
* *Default:* `0`
* *Env:* `ELASTIC_APM_SOURCE_CONTEXT_SPAN_LIBRARY_FRAMES`
...
before truncating further spans.
Setting to `Infinity` means that spans will never be truncated.
