...
** `name` {uri-string}[`<string>`] Framework name.
** `version` {uri-string}[`<string>`] Framework version.
** `overwrite` {uri-boolean}[`<boolean>`] If set to `false`,
...
** `exports` - The original export object of the module
** `agent` - The agent instance to use in the patch function
** `options` - The following options are supported:
*** `version` - The module version, if applicable.
*** `enabled` - A flag indicating if the instrumentation is enabled.
