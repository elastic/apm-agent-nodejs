---
mapped_pages:
  - https://www.elastic.co/guide/en/apm/agent/nodejs/current/restify.html
applies_to:
  stack:
  serverless:
    observability:
...
# Get started with Restify [restify]

Getting Elastic APM set up for your Restify app is easy, and there are various ways you can tweak it to fit your needs. Follow the guide below to get started, and for more advanced topics, check out the [API Reference](/reference/api.md).


## Installation [restify-installation]
...
## Initialization [restify-initialization]
...
### Advanced configuration [restify-advanced-configuration]
...
### Full documentation [restify-full-documentation]

* [Setup and Configuration](/reference/advanced-setup.md)
* [API Reference](/reference/api.md)


## Performance monitoring [restify-performance-monitoring]
...
### Unknown routes [restify-unknown-routes]
...
## Error logging [restify-error-logging]
...
## Filter sensitive information [restify-filter-sensitive-information]
...
## Add your own data [restify-add-your-own-data]
...
## Compatibility [restify-compatibility]

See [*Supported technologies*](/reference/supported-technologies.md) for details.


## Troubleshooting [restify-troubleshooting]
