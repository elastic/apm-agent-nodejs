...
set <<capture-span-stack-traces,`captureSpanStackTraces`>> to `false`.  You may also use
the <<span-frames-min-duration,`spanFramesMinDuration`>> to set a duration threshold for
