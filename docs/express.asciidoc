...
and other slow operations that happens during requests to your Express app.
...
Express works by funneling all incoming http requests through a series of middlewares (one of which being your router).
