...
|https://www.npmjs.com/package/mongodb-core[mongodb-core] |\^1.2.7 \|\| ^2.0.0 |Will trace all queries.
...
|https://www.npmjs.com/package/ws[ws] |>=1.0.0 <4.0.0 |Will trace outgoing WebSocket messages
|=======================================================================
