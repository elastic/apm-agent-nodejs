...
|https://www.npmjs.com/package/mongodb-core[mongodb-core] |\^1.2.19 \|\| ^2.0.0 |Will instrument all queries.
...
|https://www.npmjs.com/package/ws[ws] |>=1.0.0 <5.0.0 |Will instrument outgoing WebSocket messages
|=======================================================================
