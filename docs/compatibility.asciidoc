...
Previous versions of Node.js is not supported.
...
The modules and versions listed below are the once we support.
If you use a version not supported you might not be able to see your own code in the performance traces.
...
If you use a version not supported you might experience missing traces.
This does not impact the stability of your application in any way - only the collected metrics.
