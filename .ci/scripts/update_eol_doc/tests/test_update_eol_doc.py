# -*- coding: utf-8 -*-
import update_eol_doc.lib


def test_minor(args_fixture):
    ret = update_eol_doc.lib.entrypoint(args_fixture)
    assert ret == \
        """[[upgrading]]
...
def test_major(args_fixture):
    args_fixture.release = "4.0.0"
    ret = update_eol_doc.lib.entrypoint(args_fixture)
    assert ret == \
        """[[upgrading]]
...
|====
|Agent version |EOL Date |Maintained until
|4.0.0 |2021-10-08 | 4.1.0
|3.5.x |2021-10-08 | 4.0.0
|3.4.x |2021-08-21 |3.5.0
|3.3.x |2021-06-12 |3.4.0
|3.2.x |2021-05-18 |3.3.0
|3.1.x |2021-04-16 |3.2.0
