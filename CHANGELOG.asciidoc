...
* In a Lambda enviornment we now collection a number of additional data fields
  on the Transaction object.  See https://github.com/elastic/apm/blob/master/specs/agents/tracing-instrumentation-aws-lambda.md[spec for more information]
  on fields collected. ({issues}2156[#2156])
