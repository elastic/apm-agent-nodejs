...
* feat: implemented sanitize_feature_names specification
        ...
        spec: https://github.com/elastic/apm/blob/master/specs/agents/sanitization.md
        docs: https://github.com/elastic/apm-agent-nodejs/blob/master/docs/configuration.asciidoc#sanitize-field-names
