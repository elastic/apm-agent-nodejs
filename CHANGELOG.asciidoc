...
See https://www.elastic.co/guide/en/apm/agent/nodejs/current/release-notes-4.x.html[the 4.x release notes]
for the latest (4.x) releases. The 3.x branch will be maintained until
